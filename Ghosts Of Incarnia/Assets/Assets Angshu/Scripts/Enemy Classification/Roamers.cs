...
public class Roamer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        centerPoint = AssetWarmup.Instance.CenterPrefab.transform;
    }
    ...
    void OrbitCenter()
    {
        ...
        transform.RotateAround(centerPoint.position, Vector3.forward, orbitSpeed * Time.deltaTime);

        // Ensure Z-axis rotation is set to 0
